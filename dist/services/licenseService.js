...
var getAllLicense = function getAllLicense() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _index["default"].License.findAll({});
          case 3:
            licenseList = _context.sent;
            resolve({
              errCode: 0,
...
var createLicense = function createLicense(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      var isExit, hashedLicenseKey, newLicense;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 4;
            return checkDomain(data);
          case 4:
            isExit = _context2.sent;
            if (isExit) {
              _context2.next = 17;
              break;
            }
            _context2.next = 8;
            return hashLicense(data.domain);
          case 8:
            hashedLicenseKey = _context2.sent;
            _context2.next = 11;
            return _index["default"].License.create({
              licenseStatus: data.status,
              customerName: data.name,
              customerEmail: data.email,
              domain: data.domain,
              shopId: data.shopId,
              licenseKey: "LIC-".concat(hashedLicenseKey, "_key")
            });
          case 11:
            _context2.next = 13;
            return _index["default"].License.findOne({
              where: {
                domain: data.domain
              }
            });
          case 13:
            newLicense = _context2.sent;
            if (newLicense) {
              resolve({
                errCode: 0,
...
var checkDomain = function checkDomain(data) {
  return new Promise( /*#__PURE__*/function () {
...
var hashLicense = function hashLicense(domain) {
  return new Promise( /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            try {
              hash = _bcryptjs["default"].hashSync(domain, salt);
              resolve(hash);
            } catch (error) {
              reject(error);
            }
...
var authenticateLicense = function authenticateLicense(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resolve, reject) {
      var isLicenseExit, themeModule;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 7:
            ...
            _context5.next = 11;
            return _index["default"].SwiftModule.findOne({
              where: {
                id: 1
              },
              raw: false
          ...
          case 11:
            themeModule = _context5.sent;
            if (!(isLicenseExit.licenseStatus === 0 && isLicenseExit.domain === data.shopDomain)) {
              _context5.next = 19;
              break;
            }
...
var updateLicense = function updateLicense(data) {
  return new Promise( /*#__PURE__*/function () {
...
var deleteLicenseById = function deleteLicenseById(licenseId) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          ...
          case 3:
            ...
            _context7.next = 7;
            return _index["default"].License.destroy({
              where: {
                id: licenseId
              }
            });
